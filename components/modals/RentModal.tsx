...
function RentModal() {
  ...
  let bodyContent = (
    <div className='flex flex-col gap-8'>
        <Heading title='Which of thest best describes your place?' subtitle='Pick a category'/>
  ...
  if(step === STEPS.PRICE){
    bodyContent = (
      <div className='flex flex-col gap-8'>
        <Heading title='Now, set your pices' subtitle='How much do you charge per night?'/>
        <Input id='price' label='Price' formatPrices type='number' disabled={isLoading} register={register} errors={errors} required/>
      </div>
    )
  }
  return (
