...
function Modal( {isOpen, onClose, onSubmit, title, body, footer, actionLabel, disabled, secondaryAction, secondaryActionLabel}: ModalProps) {    
    ...
    return (
    <div className='fixed inset-0 z-50 overflow-y-auto overflow-x-hidden flex items-center justify-center outline-none focus:outline-none bg-neutral-800/70'>
            ...
            <div className='translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                ...
                <div className='flex flex-col gap-2 p-6'>
                    <div className='flex flex-row items-center gap-4 w-full'>
                        {secondaryAction && secondaryActionLabel && <Button outline disabled={disabled} label={secondaryActionLabel} onClick={()=>{}}/>}
